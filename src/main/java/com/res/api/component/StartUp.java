...
public class StartUp implements ApplicationRunner {
    ...
    public StartUp(RestaurantRepository restaurantRepository) {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        restaurantRepository.saveAll(Arrays.asList(restaurantA, restaurantB, restaurantC, restaurantD));

        List<Restaurant> restaurants = restaurantRepository.searchRestaurant("", "", " a");
